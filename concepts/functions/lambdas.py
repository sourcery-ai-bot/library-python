...
full = lambda first, last: f"{first.strip().title()} {last.strip().title()}"

print(full("    Wayne   ", "LAMBERT"))


# Sort a list of random names by first name and last name
names = ['Jimmy Jo Junior', 'Jack Branning', 'Tony Tiger',
        'Fred Estaire', 'Michael Jackson', 'Jamie Adams']
...
# Make a quadratic function using a lambda expression
